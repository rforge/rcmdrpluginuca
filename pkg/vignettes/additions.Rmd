...
## Example of using the "Signle-Sample Variance Test..." menu
...
1. Choose from the Rcmdr menu: "Data" -> "Packet data sets" -> "Read data set from attached package..."
...
Within the menu "Statistics" -> "Non-parametric tests" -> "Randomness test for a factor of two levels...", a new entry is provided to test the randomness of a factor-type variable with two levels. This option uses the `runs.test` function of the tseries package, although to avoid conflicts it has been renamed` twolevelfactor.runs.test`.
...
Within the "Statistics" menu -> "Non-parametric tests" -> "Randomness test for a numeric variable ...", a new entry is provided to test the randomness of a numeric variable. This option uses the `runs.test` function of the randtest package, although to avoid conflicts it has been renamed` numeric.runs.test`.
